...
<title>The Dream Home — a huge house, farmland &amp; greenhouse for Vintage Story (v1.22.3)</title>
...
<div class="shell">
  <aside class="sidebar" data-sidebar>
    <div class="brand">
      ...
      <span class="wordmark">The Dream<br>Home<small>HOUSE · FARM · GREENHOUSE</small></span>
    </div>
...
<footer class="site">
  <div class="cols">
    <div>
      <strong style="font-family:var(--f-display);color:var(--accent)">The Dream Home</strong><br>
...
writeFileSync(join(root, "vs-dreamhome.html"), html);
console.log(`wrote vs-dreamhome.html — house ${houseStruct.length} parts, farm ${farmStruct.length}, greenhouse ${ghStruct.length}, ${estateMats.length} materials`);
